  ...
  return (
    <section className="relative z-10 isolate flex min-h-[620px] items-center overflow-hidden bg-[#dce4e5] px-5 pb-12 pt-28 md:min-h-[720px] md:pt-32">
      ...
      <div className="liquid-glass relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 py-12 text-center text-[#111113] md:px-14 md:py-16">
        ...
        <h1 className="mt-3 max-w-3xl text-4xl font-semibold leading-[1.05] tracking-normal md:text-6xl">
          Nơi Bình Yên
        ...
        <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
          <a href="#schedule" className="inline-flex h-11 items-center justify-center rounded-full bg-[#0066cc] px-6 text-sm font-semibold text-white no-underline shadow-[0_8px_18px_rgba(0,102,204,0.24)]">
            Tham gia cùng chúng tôi
          </a>
          <a href="/about" className="inline-flex h-11 items-center justify-center gap-2 rounded-full px-5 text-sm font-medium text-[#0066cc] no-underline">
