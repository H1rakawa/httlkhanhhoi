...
export default function AdminSidebar({
  ...
  return (
    <aside className="z-20 flex min-h-0 flex-col overflow-hidden rounded-[22px] border border-white/70 bg-[rgba(232,241,242,0.58)] p-2.5 shadow-[0_30px_90px_rgba(31,48,70,0.16)] backdrop-blur-2xl sm:p-3 md:p-4 lg:sticky lg:top-6 lg:h-[calc(100svh-3rem)] lg:rounded-[30px] lg:bg-[rgba(231,241,240,0.5)] lg:p-6">
      <div className="min-h-0 shrink-0">
        <Link
          href="/"
          className="mb-3 flex h-10 items-center justify-center no-underline md:h-12 lg:mb-7 lg:justify-start lg:px-2"
        ...
        <nav className="grid grid-cols-4 gap-2 overflow-y-auto pr-0.5 md:grid-cols-5 lg:grid-cols-1">
          {adminSidebarItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={[
                  "flex h-11 items-center justify-center rounded-[12px] text-sm font-extrabold no-underline transition-all duration-300 lg:h-12 lg:justify-start lg:gap-3 lg:px-4",
                  isActive
      ...
      <div className="mt-3 border-t border-[#4b6174]/12 pt-3 lg:mt-auto lg:pt-6">
        <Link
          href={`/admin/${adminId}`}
          className="flex items-center justify-center rounded-2xl p-1.5 text-[#101418] no-underline transition-all duration-300 hover:bg-white/56 sm:justify-start sm:gap-3 sm:p-2"
