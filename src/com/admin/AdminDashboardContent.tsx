...
export default function AdminDashboardContent({
  ...
  return (
    <div className="relative z-10 mx-auto grid min-h-screen w-full max-w-375 gap-5 px-4 py-4 md:gap-6 md:px-6 md:py-6 lg:grid-cols-[244px_minmax(0,1fr)] xl:grid-cols-[268px_minmax(0,1fr)]">
      <AdminSidebar
        adminId={adminId}
