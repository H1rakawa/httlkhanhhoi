...
const shortcuts = [
  { label: "Làm bài tập", href: "/assignment", icon: "upload", primary: true },
  { label: "Thư viện", href: "/library", icon: "book" },
  { label: "Cầu thay", href: "/pray", icon: "community" },
];
...
export default function ShortcutsPanel() {
  return (
    <section className="liquid-readable p-5 md:p-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        {shortcuts.map((shortcut) => (
          <Link
            ...
            href={shortcut.href}
            className={[
              "flex aspect-square min-h-32 flex-col items-center justify-center gap-4 rounded-4xl border-2 px-2 text-center no-underline shadow-[0_18px_40px_rgba(31,38,48,0.12)]",
              shortcut.primary
      ...
      <div className="mt-8 rounded-4xl border border-white/80 bg-[linear-gradient(135deg,rgba(0,102,204,0.94),rgba(39,60,168,0.92))] p-8 text-white shadow-[0_18px_36px_rgba(0,102,204,0.22)]">
