...
values
  (
    'le-ky-niem-10-nam-thanh-lap-hoi-thanh',
  ...
  (
    'khoi-dong-du-an-anh-sang-do-thi',
    'Khởi Động Dự Án "Ánh Sáng Đô Thị"',
    'Tin tức',
    'Nhóm Thiện Nguyện',
  ...
  (
    'su-tinh-lang-giua-the-gioi-on-ao',
    'Sự Tĩnh Lặng Giữa Thế Giới Ồn Ào',
    'Bài chia sẻ',
    'Mục sư Quản nhiệm',
  ...
  (
    'tuyen-cong-tac-vien-ban-truyen-thong',
    'Tuyển Cộng Tác Viên Ban Truyền Thông',
    'Thông báo',
    'Ban Truyền Thông',
  ...
  (
    'chuyen-di-retreat-tro-ve-voi-thien-nhien',
    'Chuyến Đi Retreat: Trở Về Với Thiên Nhiên',
    'Tin tức',
    'Ban Chăm Sóc',
    ...
    false,
    'published',
    '2024-03-28 00:00:00+00'
  ),
  (
    'podcast-moi-loi-song-moi-ngay',
    'Podcast Mới: "Lối Sống Mỗi Ngày"',
    'Thông báo',
    'Đội Podcast',
  ...
  (
    'lop-kinh-thanh-can-ban-khoa-moi',
    'Lớp Kinh Thánh Căn Bản Khóa Mới',
    'Tin tức',
    'Ban Đào Tạo',
  ...
  (
    'cap-nhat-quy-cau-thay-thang-tu',
    'Cập Nhật Quỹ Cầu Thay Tháng Tư',
    'Bài chia sẻ',
    'Nhóm Cầu Nguyện',
